...
<p align="center">
    ...
    <a href="https://github.com/mbsulliv/crush/releases"><img src="https://img.shields.io/github/release/mbsulliv/crush" alt="Latest Release"></a>
    <a href="https://github.com/mbsulliv/crush/actions"><img src="https://github.com/mbsulliv/crush/actions/workflows/build.yml/badge.svg" alt="Build Status"></a>
</p>
...
[releases]: https://github.com/mbsulliv/crush/releases

Or just install it with Go:

```
go install github.com/mbsulliv/crush@latest
```
...
Details on exactly what's collected are in the source code ([here](https://github.com/mbsulliv/crush/tree/main/internal/event)
and [here](https://github.com/mbsulliv/crush/blob/main/internal/llm/agent/event.go)).
...
See the [contributing guide](https://github.com/mbsulliv/crush?tab=contributing-ov-file#contributing).
...
[FSL-1.1-MIT](https://github.com/mbsulliv/crush/raw/main/LICENSE.md)
